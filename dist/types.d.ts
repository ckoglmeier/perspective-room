export declare const PERSPECTIVE_ROOM_SCHEMA_VERSION: "perspective_room.v1";
export type RoomBundleMode = 'public' | 'metadata_only' | 'hybrid';
export type RoomAuthor = 'founder' | 'perspective' | 'third_party' | 'unknown';
export type RoomTrustStatus = 'draft' | 'founder_approved' | 'needs_source' | 'source_linked' | 'outdated';
